...
class TestGenerateOutputPrefix:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "video_input_long_name.mp4",
                "model",
                5,
                "video_input_long_name_model_step5",
            ),
            ("image_input.jpg", "org/model", 1, "image_input_model_step1"),
            (
                "image_input_long_name.png",
                "org/model",
                5,
                "image_input_long_name_model_step5",
            ),
        ],
    )
    def test_file_input(
    ...
    def test_complex_input_name(self, tmp_path, base_config):
        ...
        assert (
            config.generate_output_prefix()
            == "complex_name_with_underscores_model_step1"
        )
